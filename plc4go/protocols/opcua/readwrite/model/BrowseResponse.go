...
type BrowseResponse interface {
	...
	IsBrowseResponse()
	// CreateBuilder creates a BrowseResponseBuilder
	CreateBrowseResponseBuilder() BrowseResponseBuilder
}
...
// BrowseResponseBuilder is a builder for BrowseResponse
type BrowseResponseBuilder interface {
	...
	MustBuild() BrowseResponse
}

// NewBrowseResponseBuilder() creates a BrowseResponseBuilder
func NewBrowseResponseBuilder() BrowseResponseBuilder {
	return &_BrowseResponseBuilder{_BrowseResponse: new(_BrowseResponse)}
}

type _BrowseResponseBuilder struct {
	*_BrowseResponse
...
var _ (BrowseResponseBuilder) = (*_BrowseResponseBuilder)(nil)
...
func (b *_BrowseResponseBuilder) Build() (BrowseResponse, error) {
	...
	return b._BrowseResponse.deepCopy(), nil
}

func (b *_BrowseResponseBuilder) MustBuild() BrowseResponse {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_BrowseResponseBuilder) buildForExtensionObjectDefinition() (ExtensionObjectDefinition, error) {
	return b.Build()
}

func (b *_BrowseResponseBuilder) DeepCopy() any {
	_copy := b.CreateBrowseResponseBuilder().(*_BrowseResponseBuilder)
...
// CreateBrowseResponseBuilder creates a BrowseResponseBuilder
func (b *_BrowseResponse) CreateBrowseResponseBuilder() BrowseResponseBuilder {
	if b == nil {
		return NewBrowseResponseBuilder()
	}
	return &_BrowseResponseBuilder{_BrowseResponse: b.deepCopy()}
}
...
func (m *_BrowseResponse) IsBrowseResponse() {}

func (m *_BrowseResponse) DeepCopy() any {
	return m.deepCopy()
}

func (m *_BrowseResponse) deepCopy() *_BrowseResponse {
	if m == nil {
		return nil
	}
	...
	_BrowseResponseCopy.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition)._SubType = m
	return _BrowseResponseCopy
}
