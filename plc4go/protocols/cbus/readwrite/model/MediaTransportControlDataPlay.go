...
func (b *_MediaTransportControlDataPlayBuilder) setParent(contract MediaTransportControlDataContract) {
	...
	contract.(*_MediaTransportControlData)._SubType = b._MediaTransportControlDataPlay
}
...
func (m *_MediaTransportControlDataPlay) deepCopy() *_MediaTransportControlDataPlay {
	...
	_MediaTransportControlDataPlayCopy.MediaTransportControlDataContract.(*_MediaTransportControlData)._SubType = m
