...
type BACnetConstructedDataAnalogValueRelinquishDefault interface {
	...
	// CreateBuilder creates a BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
	CreateBACnetConstructedDataAnalogValueRelinquishDefaultBuilder() BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
}
...
var _ BACnetConstructedDataRequirements = (*_BACnetConstructedDataAnalogValueRelinquishDefault)(nil)
...
func NewBACnetConstructedDataAnalogValueRelinquishDefault(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, relinquishDefault BACnetApplicationTagReal, tagNumber uint8, arrayIndexArgument BACnetTagPayloadUnsignedInteger) *_BACnetConstructedDataAnalogValueRelinquishDefault {
	if relinquishDefault == nil {
		panic("relinquishDefault of type BACnetApplicationTagReal for BACnetConstructedDataAnalogValueRelinquishDefault must not be nil")
	}
...
// BACnetConstructedDataAnalogValueRelinquishDefaultBuilder is a builder for BACnetConstructedDataAnalogValueRelinquishDefault
type BACnetConstructedDataAnalogValueRelinquishDefaultBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(relinquishDefault BACnetApplicationTagReal) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
	// WithRelinquishDefault adds RelinquishDefault (property field)
	WithRelinquishDefault(BACnetApplicationTagReal) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
	// WithRelinquishDefaultBuilder adds RelinquishDefault (property field) which is build by the builder
	WithRelinquishDefaultBuilder(func(BACnetApplicationTagRealBuilder) BACnetApplicationTagRealBuilder) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
	// Done is used to finish work on this child and return (or create one if none) to the parent builder
	Done() BACnetConstructedDataBuilder
	// Build builds the BACnetConstructedDataAnalogValueRelinquishDefault or returns an error if something is wrong
	Build() (BACnetConstructedDataAnalogValueRelinquishDefault, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() BACnetConstructedDataAnalogValueRelinquishDefault
}

// NewBACnetConstructedDataAnalogValueRelinquishDefaultBuilder() creates a BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
func NewBACnetConstructedDataAnalogValueRelinquishDefaultBuilder() BACnetConstructedDataAnalogValueRelinquishDefaultBuilder {
	return &_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder{_BACnetConstructedDataAnalogValueRelinquishDefault: new(_BACnetConstructedDataAnalogValueRelinquishDefault)}
}

type _BACnetConstructedDataAnalogValueRelinquishDefaultBuilder struct {
	*_BACnetConstructedDataAnalogValueRelinquishDefault
...
var _ (BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) = (*_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder)(nil)

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) setParent(contract BACnetConstructedDataContract) {
	b.BACnetConstructedDataContract = contract
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataAnalogValueRelinquishDefault
}

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) WithMandatoryFields(relinquishDefault BACnetApplicationTagReal) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder {
	return b.WithRelinquishDefault(relinquishDefault)
}

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) WithRelinquishDefault(relinquishDefault BACnetApplicationTagReal) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder {
	b.RelinquishDefault = relinquishDefault
	return b
}

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) WithRelinquishDefaultBuilder(builderSupplier func(BACnetApplicationTagRealBuilder) BACnetApplicationTagRealBuilder) BACnetConstructedDataAnalogValueRelinquishDefaultBuilder {
...
func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) Build() (BACnetConstructedDataAnalogValueRelinquishDefault, error) {
	...
	return b._BACnetConstructedDataAnalogValueRelinquishDefault.deepCopy(), nil
}

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) MustBuild() BACnetConstructedDataAnalogValueRelinquishDefault {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) Done() BACnetConstructedDataBuilder {
...
func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) buildForBACnetConstructedData() (BACnetConstructedData, error) {
	return b.Build()
}

func (b *_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder) DeepCopy() any {
	_copy := b.CreateBACnetConstructedDataAnalogValueRelinquishDefaultBuilder().(*_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder)
...
// CreateBACnetConstructedDataAnalogValueRelinquishDefaultBuilder creates a BACnetConstructedDataAnalogValueRelinquishDefaultBuilder
func (b *_BACnetConstructedDataAnalogValueRelinquishDefault) CreateBACnetConstructedDataAnalogValueRelinquishDefaultBuilder() BACnetConstructedDataAnalogValueRelinquishDefaultBuilder {
	if b == nil {
		return NewBACnetConstructedDataAnalogValueRelinquishDefaultBuilder()
	}
	return &_BACnetConstructedDataAnalogValueRelinquishDefaultBuilder{_BACnetConstructedDataAnalogValueRelinquishDefault: b.deepCopy()}
}
...
func (m *_BACnetConstructedDataAnalogValueRelinquishDefault) GetParent() BACnetConstructedDataContract {
...
func (m *_BACnetConstructedDataAnalogValueRelinquishDefault) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConstructedData, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (__bACnetConstructedDataAnalogValueRelinquishDefault BACnetConstructedDataAnalogValueRelinquishDefault, err error) {
...
func (m *_BACnetConstructedDataAnalogValueRelinquishDefault) deepCopy() *_BACnetConstructedDataAnalogValueRelinquishDefault {
	...
	_BACnetConstructedDataAnalogValueRelinquishDefaultCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
