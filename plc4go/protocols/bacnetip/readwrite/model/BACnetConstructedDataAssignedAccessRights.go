...
type BACnetConstructedDataAssignedAccessRights interface {
	...
	// CreateBuilder creates a BACnetConstructedDataAssignedAccessRightsBuilder
	CreateBACnetConstructedDataAssignedAccessRightsBuilder() BACnetConstructedDataAssignedAccessRightsBuilder
}
...
// BACnetConstructedDataAssignedAccessRightsBuilder is a builder for BACnetConstructedDataAssignedAccessRights
type BACnetConstructedDataAssignedAccessRightsBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(assignedAccessRights []BACnetAssignedAccessRights) BACnetConstructedDataAssignedAccessRightsBuilder
	// WithNumberOfDataElements adds NumberOfDataElements (property field)
	WithOptionalNumberOfDataElements(BACnetApplicationTagUnsignedInteger) BACnetConstructedDataAssignedAccessRightsBuilder
	// WithOptionalNumberOfDataElementsBuilder adds NumberOfDataElements (property field) which is build by the builder
	WithOptionalNumberOfDataElementsBuilder(func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataAssignedAccessRightsBuilder
	// WithAssignedAccessRights adds AssignedAccessRights (property field)
	WithAssignedAccessRights(...BACnetAssignedAccessRights) BACnetConstructedDataAssignedAccessRightsBuilder
	// Done is used to finish work on this child and return (or create one if none) to the parent builder
	Done() BACnetConstructedDataBuilder
	// Build builds the BACnetConstructedDataAssignedAccessRights or returns an error if something is wrong
	Build() (BACnetConstructedDataAssignedAccessRights, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() BACnetConstructedDataAssignedAccessRights
}

// NewBACnetConstructedDataAssignedAccessRightsBuilder() creates a BACnetConstructedDataAssignedAccessRightsBuilder
func NewBACnetConstructedDataAssignedAccessRightsBuilder() BACnetConstructedDataAssignedAccessRightsBuilder {
	return &_BACnetConstructedDataAssignedAccessRightsBuilder{_BACnetConstructedDataAssignedAccessRights: new(_BACnetConstructedDataAssignedAccessRights)}
}
...
func (m *_BACnetConstructedDataAssignedAccessRights) deepCopy() *_BACnetConstructedDataAssignedAccessRights {
	...
	_BACnetConstructedDataAssignedAccessRightsCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
