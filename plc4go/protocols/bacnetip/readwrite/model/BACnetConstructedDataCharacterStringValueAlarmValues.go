...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) setParent(contract BACnetConstructedDataContract) {
	b.BACnetConstructedDataContract = contract
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataCharacterStringValueAlarmValues
}
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) WithOptionalNumberOfDataElements(numberOfDataElements BACnetApplicationTagUnsignedInteger) BACnetConstructedDataCharacterStringValueAlarmValuesBuilder {
	b.NumberOfDataElements = numberOfDataElements
	return b
}

func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) WithOptionalNumberOfDataElementsBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataCharacterStringValueAlarmValuesBuilder {
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) WithAlarmValues(alarmValues ...BACnetOptionalCharacterString) BACnetConstructedDataCharacterStringValueAlarmValuesBuilder {
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) MustBuild() BACnetConstructedDataCharacterStringValueAlarmValues {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) Done() BACnetConstructedDataBuilder {
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder) buildForBACnetConstructedData() (BACnetConstructedData, error) {
	return b.Build()
}
...
func (b *_BACnetConstructedDataCharacterStringValueAlarmValues) CreateBACnetConstructedDataCharacterStringValueAlarmValuesBuilder() BACnetConstructedDataCharacterStringValueAlarmValuesBuilder {
	if b == nil {
		return NewBACnetConstructedDataCharacterStringValueAlarmValuesBuilder()
	}
	return &_BACnetConstructedDataCharacterStringValueAlarmValuesBuilder{_BACnetConstructedDataCharacterStringValueAlarmValues: b.deepCopy()}
}
...
func (m *_BACnetConstructedDataCharacterStringValueAlarmValues) deepCopy() *_BACnetConstructedDataCharacterStringValueAlarmValues {
	...
	_BACnetConstructedDataCharacterStringValueAlarmValuesCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
