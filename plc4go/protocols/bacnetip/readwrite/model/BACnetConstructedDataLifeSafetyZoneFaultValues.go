...
type BACnetConstructedDataLifeSafetyZoneFaultValues interface {
	...
	// IsBACnetConstructedDataLifeSafetyZoneFaultValues is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsBACnetConstructedDataLifeSafetyZoneFaultValues()
	// CreateBuilder creates a BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder
	CreateBACnetConstructedDataLifeSafetyZoneFaultValuesBuilder() BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder
}
...
// BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder is a builder for BACnetConstructedDataLifeSafetyZoneFaultValues
type BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(faultValues []BACnetLifeSafetyStateTagged) BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder
	// WithFaultValues adds FaultValues (property field)
	WithFaultValues(...BACnetLifeSafetyStateTagged) BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder
	// Done is used to finish work on this child and return (or create one if none) to the parent builder
	Done() BACnetConstructedDataBuilder
	// Build builds the BACnetConstructedDataLifeSafetyZoneFaultValues or returns an error if something is wrong
	Build() (BACnetConstructedDataLifeSafetyZoneFaultValues, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() BACnetConstructedDataLifeSafetyZoneFaultValues
}

// NewBACnetConstructedDataLifeSafetyZoneFaultValuesBuilder() creates a BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder
func NewBACnetConstructedDataLifeSafetyZoneFaultValuesBuilder() BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder {
	return &_BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder{_BACnetConstructedDataLifeSafetyZoneFaultValues: new(_BACnetConstructedDataLifeSafetyZoneFaultValues)}
}
...
func (b *_BACnetConstructedDataLifeSafetyZoneFaultValuesBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataLifeSafetyZoneFaultValues
}
...
func (m *_BACnetConstructedDataLifeSafetyZoneFaultValues) GetParent() BACnetConstructedDataContract {
...
func (m *_BACnetConstructedDataLifeSafetyZoneFaultValues) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConstructedData, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (__bACnetConstructedDataLifeSafetyZoneFaultValues BACnetConstructedDataLifeSafetyZoneFaultValues, err error) {
...
func (m *_BACnetConstructedDataLifeSafetyZoneFaultValues) deepCopy() *_BACnetConstructedDataLifeSafetyZoneFaultValues {
	...
	_BACnetConstructedDataLifeSafetyZoneFaultValuesCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
