...
func NewSysexCommandExtendedAnalogBuilder() SysexCommandExtendedAnalogBuilder {
	return &_SysexCommandExtendedAnalogBuilder{_SysexCommandExtendedAnalog: new(_SysexCommandExtendedAnalog)}
}

type _SysexCommandExtendedAnalogBuilder struct {
	*_SysexCommandExtendedAnalog
...
func (b *_SysexCommandExtendedAnalogBuilder) MustBuild() SysexCommandExtendedAnalog {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_SysexCommandExtendedAnalogBuilder) buildForSysexCommand() (SysexCommand, error) {
	return b.Build()
}
...
// CreateSysexCommandExtendedAnalogBuilder creates a SysexCommandExtendedAnalogBuilder
func (b *_SysexCommandExtendedAnalog) CreateSysexCommandExtendedAnalogBuilder() SysexCommandExtendedAnalogBuilder {
	if b == nil {
		return NewSysexCommandExtendedAnalogBuilder()
	}
	return &_SysexCommandExtendedAnalogBuilder{_SysexCommandExtendedAnalog: b.deepCopy()}
}
