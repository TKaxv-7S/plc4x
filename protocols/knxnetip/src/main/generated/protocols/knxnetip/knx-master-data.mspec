...
[enum uint 32 KnxDatapointType(uint 16 number, KnxDatapointMainType datapointMainType, string 8 name, PlcValueType plcValueTpe)
    ...
    // End: Custom types
        ['27' DPT_Switch ['1', 'DPT_1_BIT', '"switch"', 'BOOL']]
    ['28' DPT_Bool ['2', 'DPT_1_BIT', '"boolean"', 'BOOL']]
    ['29' DPT_Enable ['3', 'DPT_1_BIT', '"enable"', 'BOOL']]
    ['30' DPT_Ramp ['4', 'DPT_1_BIT', '"ramp"', 'BOOL']]
    ['31' DPT_Alarm ['5', 'DPT_1_BIT', '"alarm"', 'BOOL']]
    ['32' DPT_BinaryValue ['6', 'DPT_1_BIT', '"binary value"', 'BOOL']]
    ['33' DPT_Step ['7', 'DPT_1_BIT', '"step"', 'BOOL']]
    ['34' DPT_UpDown ['8', 'DPT_1_BIT', '"up/down"', 'BOOL']]
    ['35' DPT_OpenClose ['9', 'DPT_1_BIT', '"open/close"', 'BOOL']]
    ['36' DPT_Start ['10', 'DPT_1_BIT', '"start/stop"', 'BOOL']]
    ['37' DPT_State ['11', 'DPT_1_BIT', '"state"', 'BOOL']]
    ['38' DPT_Invert ['12', 'DPT_1_BIT', '"invert"', 'BOOL']]
    ['39' DPT_DimSendStyle ['13', 'DPT_1_BIT', '"dim send style"', 'BOOL']]
    ['40' DPT_InputSource ['14', 'DPT_1_BIT', '"input source"', 'BOOL']]
    ['41' DPT_Reset ['15', 'DPT_1_BIT', '"reset"', 'BOOL']]
    ['42' DPT_Ack ['16', 'DPT_1_BIT', '"acknowledge"', 'BOOL']]
    ['43' DPT_Trigger ['17', 'DPT_1_BIT', '"trigger"', 'BOOL']]
    ['44' DPT_Occupancy ['18', 'DPT_1_BIT', '"occupancy"', 'BOOL']]
    ['45' DPT_Window_Door ['19', 'DPT_1_BIT', '"window/door"', 'BOOL']]
    ['46' DPT_LogicalFunction ['21', 'DPT_1_BIT', '"logical function"', 'BOOL']]
    ['47' DPT_Scene_AB ['22', 'DPT_1_BIT', '"scene"', 'BOOL']]
    ['48' DPT_ShutterBlinds_Mode ['23', 'DPT_1_BIT', '"shutter/blinds mode"', 'BOOL']]
    ['49' DPT_DayNight ['24', 'DPT_1_BIT', '"day/night"', 'BOOL']]
    ['50' DPT_Heat_Cool ['100', 'DPT_1_BIT', '"cooling/heating"', 'BOOL']]
    ['51' DPT_Switch_Control ['1', 'DPT_1_BIT_CONTROLLED', '"switch control"', 'Struct']]
    ['52' DPT_Bool_Control ['2', 'DPT_1_BIT_CONTROLLED', '"boolean control"', 'Struct']]
    ['53' DPT_Enable_Control ['3', 'DPT_1_BIT_CONTROLLED', '"enable control"', 'Struct']]
    ['54' DPT_Ramp_Control ['4', 'DPT_1_BIT_CONTROLLED', '"ramp control"', 'Struct']]
    ['55' DPT_Alarm_Control ['5', 'DPT_1_BIT_CONTROLLED', '"alarm control"', 'Struct']]
    ['56' DPT_BinaryValue_Control ['6', 'DPT_1_BIT_CONTROLLED', '"binary value control"', 'Struct']]
    ['57' DPT_Step_Control ['7', 'DPT_1_BIT_CONTROLLED', '"step control"', 'Struct']]
    ['58' DPT_Direction1_Control ['8', 'DPT_1_BIT_CONTROLLED', '"direction control 1"', 'Struct']]
    ['59' DPT_Direction2_Control ['9', 'DPT_1_BIT_CONTROLLED', '"direction control 2"', 'Struct']]
    ['60' DPT_Start_Control ['10', 'DPT_1_BIT_CONTROLLED', '"start control"', 'Struct']]
    ['61' DPT_State_Control ['11', 'DPT_1_BIT_CONTROLLED', '"state control"', 'Struct']]
    ['62' DPT_Invert_Control ['12', 'DPT_1_BIT_CONTROLLED', '"invert control"', 'Struct']]
    ['63' DPT_Control_Dimming ['7', 'DPT_3_BIT_CONTROLLED', '"dimming control"', 'Struct']]
    ['64' DPT_Control_Blinds ['8', 'DPT_3_BIT_CONTROLLED', '"blind control"', 'Struct']]
    ['65' DPT_Char_ASCII ['1', 'DPT_CHARACTER', '"character (ASCII)"', 'STRING']]
    ['66' DPT_Char_8859_1 ['2', 'DPT_CHARACTER', '"character (ISO 8859-1)"', 'STRING']]
    ['67' DPT_Scaling ['1', 'DPT_8_BIT_UNSIGNED_VALUE', '"percentage (0..100%)"', 'USINT']]
    ['68' DPT_Angle ['3', 'DPT_8_BIT_UNSIGNED_VALUE', '"angle (degrees)"', 'USINT']]
    ['69' DPT_Percent_U8 ['4', 'DPT_8_BIT_UNSIGNED_VALUE', '"percentage (0..255%)"', 'USINT']]
    ['70' DPT_DecimalFactor ['5', 'DPT_8_BIT_UNSIGNED_VALUE', '"ratio (0..255)"', 'USINT']]
    ['71' DPT_Tariff ['6', 'DPT_8_BIT_UNSIGNED_VALUE', '"tariff (0..255)"', 'USINT']]
    ['72' DPT_Value_1_Ucount ['10', 'DPT_8_BIT_UNSIGNED_VALUE', '"counter pulses (0..255)"', 'USINT']]
    ['73' DPT_FanStage ['100', 'DPT_8_BIT_UNSIGNED_VALUE', '"fan stage (0..255)"', 'USINT']]
    ['74' DPT_Percent_V8 ['1', 'DPT_8_BIT_SIGNED_VALUE', '"percentage (-128..127%)"', 'SINT']]
    ['75' DPT_Value_1_Count ['10', 'DPT_8_BIT_SIGNED_VALUE', '"counter pulses (-128..127)"', 'SINT']]
    ['76' DPT_Status_Mode3 ['20', 'DPT_8_BIT_SIGNED_VALUE', '"status with mode"', 'Struct']]
    ['77' DPT_Value_2_Ucount ['1', 'DPT_2_BYTE_UNSIGNED_VALUE', '"pulses"', 'UINT']]
    ['78' DPT_TimePeriodMsec ['2', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (ms)"', 'UINT']]
    ['79' DPT_TimePeriod10Msec ['3', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (10 ms)"', 'UINT']]
    ['80' DPT_TimePeriod100Msec ['4', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (100 ms)"', 'UINT']]
    ['81' DPT_TimePeriodSec ['5', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (s)"', 'UINT']]
    ['82' DPT_TimePeriodMin ['6', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (min)"', 'UINT']]
    ['83' DPT_TimePeriodHrs ['7', 'DPT_2_BYTE_UNSIGNED_VALUE', '"time (h)"', 'UINT']]
    ['84' DPT_PropDataType ['10', 'DPT_2_BYTE_UNSIGNED_VALUE', '"property data type"', 'UINT']]
    ['85' DPT_Length_mm ['11', 'DPT_2_BYTE_UNSIGNED_VALUE', '"length (mm)"', 'UINT']]
    ['86' DPT_UElCurrentmA ['12', 'DPT_2_BYTE_UNSIGNED_VALUE', '"current (mA)"', 'UINT']]
    ['87' DPT_Brightness ['13', 'DPT_2_BYTE_UNSIGNED_VALUE', '"brightness (lux)"', 'UINT']]
    ['88' DPT_Absolute_Colour_Temperature ['600', 'DPT_2_BYTE_UNSIGNED_VALUE', '"absolute colour temperature (K)"', 'UINT']]
    ['89' DPT_Value_2_Count ['1', 'DPT_2_BYTE_SIGNED_VALUE', '"pulses difference"', 'INT']]
    ['90' DPT_DeltaTimeMsec ['2', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag (ms)"', 'INT']]
    ['91' DPT_DeltaTime10Msec ['3', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag(10 ms)"', 'INT']]
    ['92' DPT_DeltaTime100Msec ['4', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag (100 ms)"', 'INT']]
    ['93' DPT_DeltaTimeSec ['5', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag (s)"', 'INT']]
    ['94' DPT_DeltaTimeMin ['6', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag (min)"', 'INT']]
    ['95' DPT_DeltaTimeHrs ['7', 'DPT_2_BYTE_SIGNED_VALUE', '"time lag (h)"', 'INT']]
    ['96' DPT_Percent_V16 ['10', 'DPT_2_BYTE_SIGNED_VALUE', '"percentage difference (%)"', 'INT']]
    ['97' DPT_Rotation_Angle ['11', 'DPT_2_BYTE_SIGNED_VALUE', '"rotation angle (°)"', 'INT']]
    ['98' DPT_Length_m ['12', 'DPT_2_BYTE_SIGNED_VALUE', '"length (m)"', 'INT']]
    ['99' DPT_Value_Temp ['1', 'DPT_2_BYTE_FLOAT_VALUE', '"temperature (°C)"', 'REAL']]
    ['100' DPT_Value_Tempd ['2', 'DPT_2_BYTE_FLOAT_VALUE', '"temperature difference (K)"', 'REAL']]
    ['101' DPT_Value_Tempa ['3', 'DPT_2_BYTE_FLOAT_VALUE', '"kelvin/hour (K/h)"', 'REAL']]
    ['102' DPT_Value_Lux ['4', 'DPT_2_BYTE_FLOAT_VALUE', '"lux (Lux)"', 'REAL']]
    ['103' DPT_Value_Wsp ['5', 'DPT_2_BYTE_FLOAT_VALUE', '"speed (m/s)"', 'REAL']]
    ['104' DPT_Value_Pres ['6', 'DPT_2_BYTE_FLOAT_VALUE', '"pressure (Pa)"', 'REAL']]
    ['105' DPT_Value_Humidity ['7', 'DPT_2_BYTE_FLOAT_VALUE', '"humidity (%)"', 'REAL']]
    ['106' DPT_Value_AirQuality ['8', 'DPT_2_BYTE_FLOAT_VALUE', '"parts/million (ppm)"', 'REAL']]
    ['107' DPT_Value_AirFlow ['9', 'DPT_2_BYTE_FLOAT_VALUE', '"air flow (m³/h)"', 'REAL']]
    ['108' DPT_Value_Time1 ['10', 'DPT_2_BYTE_FLOAT_VALUE', '"time (s)"', 'REAL']]
    ['109' DPT_Value_Time2 ['11', 'DPT_2_BYTE_FLOAT_VALUE', '"time (ms)"', 'REAL']]
    ['110' DPT_Value_Volt ['20', 'DPT_2_BYTE_FLOAT_VALUE', '"voltage (mV)"', 'REAL']]
    ['111' DPT_Value_Curr ['21', 'DPT_2_BYTE_FLOAT_VALUE', '"current (mA)"', 'REAL']]
    ['112' DPT_PowerDensity ['22', 'DPT_2_BYTE_FLOAT_VALUE', '"power density (W/m²)"', 'REAL']]
    ['113' DPT_KelvinPerPercent ['23', 'DPT_2_BYTE_FLOAT_VALUE', '"kelvin/percent (K/%)"', 'REAL']]
    ['114' DPT_Power ['24', 'DPT_2_BYTE_FLOAT_VALUE', '"power (kW)"', 'REAL']]
    ['115' DPT_Value_Volume_Flow ['25', 'DPT_2_BYTE_FLOAT_VALUE', '"volume flow (l/h)"', 'REAL']]
    ['116' DPT_Rain_Amount ['26', 'DPT_2_BYTE_FLOAT_VALUE', '"rain amount (l/m²)"', 'REAL']]
    ['117' DPT_Value_Temp_F ['27', 'DPT_2_BYTE_FLOAT_VALUE', '"temperature (°F)"', 'REAL']]
    ['118' DPT_Value_Wsp_kmh ['28', 'DPT_2_BYTE_FLOAT_VALUE', '"wind speed (km/h)"', 'REAL']]
    ['119' DPT_Value_Absolute_Humidity ['29', 'DPT_2_BYTE_FLOAT_VALUE', '"absolute humidity (g/m³)"', 'REAL']]
    ['120' DPT_Concentration_ygm3 ['30', 'DPT_2_BYTE_FLOAT_VALUE', '"concentration (µg/m³)"', 'REAL']]
    ['121' DPT_Coefficient ['31', 'DPT_2_BYTE_FLOAT_VALUE', '"coefficient"', 'REAL']]
    ['122' DPT_TimeOfDay ['1', 'DPT_TIME', '"time of day"', 'Struct']]
    ['123' DPT_Date ['1', 'DPT_DATE', '"date"', 'Struct']]
    ['124' DPT_Value_4_Ucount ['1', 'DPT_4_BYTE_UNSIGNED_VALUE', '"counter pulses (unsigned)"', 'UDINT']]
    ['125' DPT_LongTimePeriod_Sec ['100', 'DPT_4_BYTE_UNSIGNED_VALUE', '"counter timesec (s)"', 'UDINT']]
    ['126' DPT_LongTimePeriod_Min ['101', 'DPT_4_BYTE_UNSIGNED_VALUE', '"counter timemin (min)"', 'UDINT']]
    ['127' DPT_LongTimePeriod_Hrs ['102', 'DPT_4_BYTE_UNSIGNED_VALUE', '"counter timehrs (h)"', 'UDINT']]
    ['128' DPT_VolumeLiquid_Litre ['1200', 'DPT_4_BYTE_UNSIGNED_VALUE', '"volume liquid (l)"', 'UDINT']]
    ['129' DPT_Volume_m_3 ['1201', 'DPT_4_BYTE_UNSIGNED_VALUE', '"volume (m³)"', 'UDINT']]
    ['130' DPT_Value_4_Count ['1', 'DPT_4_BYTE_SIGNED_VALUE', '"counter pulses (signed)"', 'DINT']]
    ['131' DPT_FlowRate_m3h ['2', 'DPT_4_BYTE_SIGNED_VALUE', '"flow rate (m³/h)"', 'DINT']]
    ['132' DPT_ActiveEnergy ['10', 'DPT_4_BYTE_SIGNED_VALUE', '"active energy (Wh)"', 'DINT']]
    ['133' DPT_ApparentEnergy ['11', 'DPT_4_BYTE_SIGNED_VALUE', '"apparent energy (VAh)"', 'DINT']]
    ['134' DPT_ReactiveEnergy ['12', 'DPT_4_BYTE_SIGNED_VALUE', '"reactive energy (VARh)"', 'DINT']]
    ['135' DPT_ActiveEnergy_kWh ['13', 'DPT_4_BYTE_SIGNED_VALUE', '"active energy (kWh)"', 'DINT']]
    ['136' DPT_ApparentEnergy_kVAh ['14', 'DPT_4_BYTE_SIGNED_VALUE', '"apparent energy (kVAh)"', 'DINT']]
    ['137' DPT_ReactiveEnergy_kVARh ['15', 'DPT_4_BYTE_SIGNED_VALUE', '"reactive energy (kVARh)"', 'DINT']]
    ['138' DPT_ActiveEnergy_MWh ['16', 'DPT_4_BYTE_SIGNED_VALUE', '"active energy (MWh)"', 'DINT']]
    ['139' DPT_LongDeltaTimeSec ['100', 'DPT_4_BYTE_SIGNED_VALUE', '"time lag (s)"', 'DINT']]
    ['140' DPT_DeltaVolumeLiquid_Litre  ['1200', 'DPT_4_BYTE_SIGNED_VALUE', '"delta volume liquid (l)"', 'DINT']]
    ['141' DPT_DeltaVolume_m_3 ['1201', 'DPT_4_BYTE_SIGNED_VALUE', '"delta volume (m³)"', 'DINT']]
    ['142' DPT_Value_Acceleration ['0', 'DPT_4_BYTE_FLOAT_VALUE', '"acceleration (m/s²)"', 'REAL']]
    ['143' DPT_Value_Acceleration_Angular ['1', 'DPT_4_BYTE_FLOAT_VALUE', '"angular acceleration (rad/s²)"', 'REAL']]
    ['144' DPT_Value_Activation_Energy ['2', 'DPT_4_BYTE_FLOAT_VALUE', '"activation energy (J/mol)"', 'REAL']]
    ['145' DPT_Value_Activity ['3', 'DPT_4_BYTE_FLOAT_VALUE', '"radioactive activity (1/s)"', 'REAL']]
    ['146' DPT_Value_Mol ['4', 'DPT_4_BYTE_FLOAT_VALUE', '"amount of substance (mol)"', 'REAL']]
    ['147' DPT_Value_Amplitude ['5', 'DPT_4_BYTE_FLOAT_VALUE', '"amplitude"', 'REAL']]
    ['148' DPT_Value_AngleRad ['6', 'DPT_4_BYTE_FLOAT_VALUE', '"angle (radiant)"', 'REAL']]
    ['149' DPT_Value_AngleDeg ['7', 'DPT_4_BYTE_FLOAT_VALUE', '"angle (degree)"', 'REAL']]
    ['150' DPT_Value_Angular_Momentum ['8', 'DPT_4_BYTE_FLOAT_VALUE', '"angular momentum (Js)"', 'REAL']]
    ['151' DPT_Value_Angular_Velocity ['9', 'DPT_4_BYTE_FLOAT_VALUE', '"angular velocity (rad/s)"', 'REAL']]
    ['152' DPT_Value_Area ['10', 'DPT_4_BYTE_FLOAT_VALUE', '"area (m*m)"', 'REAL']]
    ['153' DPT_Value_Capacitance ['11', 'DPT_4_BYTE_FLOAT_VALUE', '"capacitance (F)"', 'REAL']]
    ['154' DPT_Value_Charge_DensitySurface ['12', 'DPT_4_BYTE_FLOAT_VALUE', '"flux density (C/m²)"', 'REAL']]
    ['155' DPT_Value_Charge_DensityVolume ['13', 'DPT_4_BYTE_FLOAT_VALUE', '"charge density (C/m³)"', 'REAL']]
    ['156' DPT_Value_Compressibility ['14', 'DPT_4_BYTE_FLOAT_VALUE', '"compressibility (m²/N)"', 'REAL']]
    ['157' DPT_Value_Conductance ['15', 'DPT_4_BYTE_FLOAT_VALUE', '"conductance (S)"', 'REAL']]
    ['158' DPT_Value_Electrical_Conductivity ['16', 'DPT_4_BYTE_FLOAT_VALUE', '"conductivity  (S/m)"', 'REAL']]
    ['159' DPT_Value_Density ['17', 'DPT_4_BYTE_FLOAT_VALUE', '"density (kg/m³)"', 'REAL']]
    ['160' DPT_Value_Electric_Charge ['18', 'DPT_4_BYTE_FLOAT_VALUE', '"electric charge (C)"', 'REAL']]
    ['161' DPT_Value_Electric_Current ['19', 'DPT_4_BYTE_FLOAT_VALUE', '"electric current (A)"', 'REAL']]
    ['162' DPT_Value_Electric_CurrentDensity ['20', 'DPT_4_BYTE_FLOAT_VALUE', '"electric current density (A/m²)"', 'REAL']]
    ['163' DPT_Value_Electric_DipoleMoment ['21', 'DPT_4_BYTE_FLOAT_VALUE', '"electric dipole moment (Cm)"', 'REAL']]
    ['164' DPT_Value_Electric_Displacement ['22', 'DPT_4_BYTE_FLOAT_VALUE', '"electric displacement (C/m²)"', 'REAL']]
    ['165' DPT_Value_Electric_FieldStrength ['23', 'DPT_4_BYTE_FLOAT_VALUE', '"electric field strength (V/m)"', 'REAL']]
    ['166' DPT_Value_Electric_Flux ['24', 'DPT_4_BYTE_FLOAT_VALUE', '"electric flux (C)"', 'REAL']]
    ['167' DPT_Value_Electric_FluxDensity ['25', 'DPT_4_BYTE_FLOAT_VALUE', '"electric flux density (C/m²)"', 'REAL']]
    ['168' DPT_Value_Electric_Polarization ['26', 'DPT_4_BYTE_FLOAT_VALUE', '"electric polarization (C/m²)"', 'REAL']]
    ['169' DPT_Value_Electric_Potential ['27', 'DPT_4_BYTE_FLOAT_VALUE', '"electric potential (V)"', 'REAL']]
    ['170' DPT_Value_Electric_PotentialDifference ['28', 'DPT_4_BYTE_FLOAT_VALUE', '"electric potential difference (V)"', 'REAL']]
    ['171' DPT_Value_ElectromagneticMoment ['29', 'DPT_4_BYTE_FLOAT_VALUE', '"electromagnetic moment (Am²)"', 'REAL']]
    ['172' DPT_Value_Electromotive_Force ['30', 'DPT_4_BYTE_FLOAT_VALUE', '"electromotive force (V)"', 'REAL']]
    ['173' DPT_Value_Energy ['31', 'DPT_4_BYTE_FLOAT_VALUE', '"energy (J)"', 'REAL']]
    ['174' DPT_Value_Force ['32', 'DPT_4_BYTE_FLOAT_VALUE', '"force (N)"', 'REAL']]
    ['175' DPT_Value_Frequency ['33', 'DPT_4_BYTE_FLOAT_VALUE', '"frequency (Hz)"', 'REAL']]
    ['176' DPT_Value_Angular_Frequency ['34', 'DPT_4_BYTE_FLOAT_VALUE', '"angular frequency (rad/s)"', 'REAL']]
    ['177' DPT_Value_Heat_Capacity ['35', 'DPT_4_BYTE_FLOAT_VALUE', '"heat capacity (J/K)"', 'REAL']]
    ['178' DPT_Value_Heat_FlowRate ['36', 'DPT_4_BYTE_FLOAT_VALUE', '"heat flow rate (W)"', 'REAL']]
    ['179' DPT_Value_Heat_Quantity ['37', 'DPT_4_BYTE_FLOAT_VALUE', '"heat quantity"', 'REAL']]
    ['180' DPT_Value_Impedance ['38', 'DPT_4_BYTE_FLOAT_VALUE', '"impedance (Ω)"', 'REAL']]
    ['181' DPT_Value_Length ['39', 'DPT_4_BYTE_FLOAT_VALUE', '"length (m)"', 'REAL']]
    ['182' DPT_Value_Light_Quantity ['40', 'DPT_4_BYTE_FLOAT_VALUE', '"light quantity (J)"', 'REAL']]
    ['183' DPT_Value_Luminance ['41', 'DPT_4_BYTE_FLOAT_VALUE', '"luminance (cd/m²)"', 'REAL']]
    ['184' DPT_Value_Luminous_Flux ['42', 'DPT_4_BYTE_FLOAT_VALUE', '"luminous flux (lm)"', 'REAL']]
    ['185' DPT_Value_Luminous_Intensity ['43', 'DPT_4_BYTE_FLOAT_VALUE', '"luminous intensity (cd)"', 'REAL']]
    ['186' DPT_Value_Magnetic_FieldStrength ['44', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetic field strength (A/m)"', 'REAL']]
    ['187' DPT_Value_Magnetic_Flux ['45', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetic flux (Wb)"', 'REAL']]
    ['188' DPT_Value_Magnetic_FluxDensity ['46', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetic flux density (T)"', 'REAL']]
    ['189' DPT_Value_Magnetic_Moment ['47', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetic moment (Am²)"', 'REAL']]
    ['190' DPT_Value_Magnetic_Polarization ['48', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetic polarization (T)"', 'REAL']]
    ['191' DPT_Value_Magnetization ['49', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetization (A/m)"', 'REAL']]
    ['192' DPT_Value_MagnetomotiveForce ['50', 'DPT_4_BYTE_FLOAT_VALUE', '"magnetomotive force (A)"', 'REAL']]
    ['193' DPT_Value_Mass ['51', 'DPT_4_BYTE_FLOAT_VALUE', '"mass (kg)"', 'REAL']]
    ['194' DPT_Value_MassFlux ['52', 'DPT_4_BYTE_FLOAT_VALUE', '"mass flux (kg/s)"', 'REAL']]
    ['195' DPT_Value_Momentum ['53', 'DPT_4_BYTE_FLOAT_VALUE', '"momentum (N/s)"', 'REAL']]
    ['196' DPT_Value_Phase_AngleRad ['54', 'DPT_4_BYTE_FLOAT_VALUE', '"phase angle (rad)"', 'REAL']]
    ['197' DPT_Value_Phase_AngleDeg ['55', 'DPT_4_BYTE_FLOAT_VALUE', '"phase angle (°)"', 'REAL']]
    ['198' DPT_Value_Power ['56', 'DPT_4_BYTE_FLOAT_VALUE', '"power (W)"', 'REAL']]
    ['199' DPT_Value_Power_Factor ['57', 'DPT_4_BYTE_FLOAT_VALUE', '"power factor (cos Φ)"', 'REAL']]
    ['200' DPT_Value_Pressure ['58', 'DPT_4_BYTE_FLOAT_VALUE', '"pressure (Pa)"', 'REAL']]
    ['201' DPT_Value_Reactance ['59', 'DPT_4_BYTE_FLOAT_VALUE', '"reactance (Ω)"', 'REAL']]
    ['202' DPT_Value_Resistance ['60', 'DPT_4_BYTE_FLOAT_VALUE', '"resistance (Ω)"', 'REAL']]
    ['203' DPT_Value_Resistivity ['61', 'DPT_4_BYTE_FLOAT_VALUE', '"resistivity (Ωm)"', 'REAL']]
    ['204' DPT_Value_SelfInductance ['62', 'DPT_4_BYTE_FLOAT_VALUE', '"self inductance (H)"', 'REAL']]
    ['205' DPT_Value_SolidAngle ['63', 'DPT_4_BYTE_FLOAT_VALUE', '"solid angle (sr)"', 'REAL']]
    ['206' DPT_Value_Sound_Intensity ['64', 'DPT_4_BYTE_FLOAT_VALUE', '"sound intensity (W/m²)"', 'REAL']]
    ['207' DPT_Value_Speed ['65', 'DPT_4_BYTE_FLOAT_VALUE', '"speed (m/s)"', 'REAL']]
    ['208' DPT_Value_Stress ['66', 'DPT_4_BYTE_FLOAT_VALUE', '"stress (Pa)"', 'REAL']]
    ['209' DPT_Value_Surface_Tension ['67', 'DPT_4_BYTE_FLOAT_VALUE', '"surface tension (N/m)"', 'REAL']]
    ['210' DPT_Value_Common_Temperature ['68', 'DPT_4_BYTE_FLOAT_VALUE', '"temperature (°C)"', 'REAL']]
    ['211' DPT_Value_Absolute_Temperature ['69', 'DPT_4_BYTE_FLOAT_VALUE', '"temperature absolute (K)"', 'REAL']]
    ['212' DPT_Value_TemperatureDifference ['70', 'DPT_4_BYTE_FLOAT_VALUE', '"temperature difference (K)"', 'REAL']]
    ['213' DPT_Value_Thermal_Capacity ['71', 'DPT_4_BYTE_FLOAT_VALUE', '"thermal capacity (J/K)"', 'REAL']]
    ['214' DPT_Value_Thermal_Conductivity ['72', 'DPT_4_BYTE_FLOAT_VALUE', '"thermal conductivity (W/mK)"', 'REAL']]
    ['215' DPT_Value_ThermoelectricPower ['73', 'DPT_4_BYTE_FLOAT_VALUE', '"thermoelectric power (V/K)"', 'REAL']]
    ['216' DPT_Value_Time ['74', 'DPT_4_BYTE_FLOAT_VALUE', '"time (s)"', 'REAL']]
    ['217' DPT_Value_Torque ['75', 'DPT_4_BYTE_FLOAT_VALUE', '"torque (Nm)"', 'REAL']]
    ['218' DPT_Value_Volume ['76', 'DPT_4_BYTE_FLOAT_VALUE', '"volume (m³)"', 'REAL']]
    ['219' DPT_Value_Volume_Flux ['77', 'DPT_4_BYTE_FLOAT_VALUE', '"volume flux (m³/s)"', 'REAL']]
    ['220' DPT_Value_Weight ['78', 'DPT_4_BYTE_FLOAT_VALUE', '"weight (N)"', 'REAL']]
    ['221' DPT_Value_Work ['79', 'DPT_4_BYTE_FLOAT_VALUE', '"work (J)"', 'REAL']]
    ['222' DPT_Value_ApparentPower ['80', 'DPT_4_BYTE_FLOAT_VALUE', '"apparent power (VA)"', 'REAL']]
    ['223' DPT_Volume_Flux_Meter ['1200', 'DPT_4_BYTE_FLOAT_VALUE', '"volume flux for meters (m³/h)"', 'REAL']]
    ['224' DPT_Volume_Flux_ls ['1201', 'DPT_4_BYTE_FLOAT_VALUE', '"volume flux for meters (1/ls)"', 'REAL']]
    ['225' DPT_Access_Data ['0', 'DPT_ENTRANCE_ACCESS', '"entrance access"', 'Struct']]
    ['226' DPT_String_ASCII ['0', 'DPT_CHARACTER_STRING', '"Character String (ASCII)"', 'STRING']]
    ['227' DPT_String_8859_1 ['1', 'DPT_CHARACTER_STRING', '"Character String (ISO 8859-1)"', 'STRING']]
    ['228' DPT_SceneNumber ['1', 'DPT_SCENE_NUMBER', '"scene number"', 'USINT']]
    ['229' DPT_SceneControl ['1', 'DPT_SCENE_CONTROL', '"scene control"', 'Struct']]
    ['230' DPT_DateTime ['1', 'DPT_DATE_TIME', '"date time"', 'Struct']]
    ['231' DPT_SCLOMode ['1', 'DPT_1_BYTE', '"SCLO mode"', 'USINT']]
    ['232' DPT_BuildingMode ['2', 'DPT_1_BYTE', '"building mode"', 'USINT']]
    ['233' DPT_OccMode ['3', 'DPT_1_BYTE', '"occupied"', 'USINT']]
    ['234' DPT_Priority ['4', 'DPT_1_BYTE', '"priority"', 'USINT']]
    ['235' DPT_LightApplicationMode ['5', 'DPT_1_BYTE', '"light application mode"', 'USINT']]
    ['236' DPT_ApplicationArea ['6', 'DPT_1_BYTE', '"light application area"', 'USINT']]
    ['237' DPT_AlarmClassType ['7', 'DPT_1_BYTE', '"alarm class"', 'USINT']]
    ['238' DPT_PSUMode ['8', 'DPT_1_BYTE', '"PSU mode"', 'USINT']]
    ['239' DPT_ErrorClass_System ['11', 'DPT_1_BYTE', '"system error class"', 'USINT']]
    ['240' DPT_ErrorClass_HVAC ['12', 'DPT_1_BYTE', '"HVAC error class"', 'USINT']]
    ['241' DPT_Time_Delay ['13', 'DPT_1_BYTE', '"time delay"', 'USINT']]
    ['242' DPT_Beaufort_Wind_Force_Scale ['14', 'DPT_1_BYTE', '"wind force scale (0..12)"', 'USINT']]
    ['243' DPT_SensorSelect ['17', 'DPT_1_BYTE', '"sensor mode"', 'USINT']]
    ['244' DPT_ActuatorConnectType ['20', 'DPT_1_BYTE', '"actuator connect type"', 'USINT']]
    ['245' DPT_Cloud_Cover ['21', 'DPT_1_BYTE', '"cloud cover"', 'USINT']]
    ['246' DPT_PowerReturnMode ['22', 'DPT_1_BYTE', '"power return mode"', 'USINT']]
    ['247' DPT_FuelType ['100', 'DPT_1_BYTE', '"fuel type"', 'USINT']]
    ['248' DPT_BurnerType ['101', 'DPT_1_BYTE', '"burner type"', 'USINT']]
    ['249' DPT_HVACMode ['102', 'DPT_1_BYTE', '"HVAC mode"', 'USINT']]
    ['250' DPT_DHWMode ['103', 'DPT_1_BYTE', '"DHW mode"', 'USINT']]
    ['251' DPT_LoadPriority ['104', 'DPT_1_BYTE', '"load priority"', 'USINT']]
    ['252' DPT_HVACContrMode ['105', 'DPT_1_BYTE', '"HVAC control mode"', 'USINT']]
    ['253' DPT_HVACEmergMode ['106', 'DPT_1_BYTE', '"HVAC emergency mode"', 'USINT']]
    ['254' DPT_ChangeoverMode ['107', 'DPT_1_BYTE', '"changeover mode"', 'USINT']]
    ['255' DPT_ValveMode ['108', 'DPT_1_BYTE', '"valve mode"', 'USINT']]
    ['256' DPT_DamperMode ['109', 'DPT_1_BYTE', '"damper mode"', 'USINT']]
    ['257' DPT_HeaterMode ['110', 'DPT_1_BYTE', '"heater mode"', 'USINT']]
    ['258' DPT_FanMode ['111', 'DPT_1_BYTE', '"fan mode"', 'USINT']]
    ['259' DPT_MasterSlaveMode ['112', 'DPT_1_BYTE', '"master/slave mode"', 'USINT']]
    ['260' DPT_StatusRoomSetp ['113', 'DPT_1_BYTE', '"status room setpoint"', 'USINT']]
    ['261' DPT_Metering_DeviceType ['114', 'DPT_1_BYTE', '"metering device type"', 'USINT']]
    ['262' DPT_HumDehumMode ['115', 'DPT_1_BYTE', '"hum dehum mode"', 'USINT']]
    ['263' DPT_EnableHCStage ['116', 'DPT_1_BYTE', '"enable H/C stage"', 'USINT']]
    ['264' DPT_ADAType ['120', 'DPT_1_BYTE', '"ADA type"', 'USINT']]
    ['265' DPT_BackupMode ['121', 'DPT_1_BYTE', '"backup mode"', 'USINT']]
    ['266' DPT_StartSynchronization ['122', 'DPT_1_BYTE', '"start syncronization type"', 'USINT']]
    ['267' DPT_Behaviour_Lock_Unlock ['600', 'DPT_1_BYTE', '"behavior lock/unlock"', 'USINT']]
    ['268' DPT_Behaviour_Bus_Power_Up_Down ['601', 'DPT_1_BYTE', '"behavior bus power up/down"', 'USINT']]
    ['269' DPT_DALI_Fade_Time ['602', 'DPT_1_BYTE', '"dali fade time"', 'USINT']]
    ['270' DPT_BlinkingMode ['603', 'DPT_1_BYTE', '"blink mode"', 'USINT']]
    ['271' DPT_LightControlMode ['604', 'DPT_1_BYTE', '"light control mode"', 'USINT']]
    ['272' DPT_SwitchPBModel ['605', 'DPT_1_BYTE', '"PB switch mode"', 'USINT']]
    ['273' DPT_PBAction ['606', 'DPT_1_BYTE', '"PB action mode"', 'USINT']]
    ['274' DPT_DimmPBModel ['607', 'DPT_1_BYTE', '"PB dimm mode"', 'USINT']]
    ['275' DPT_SwitchOnMode ['608', 'DPT_1_BYTE', '"switch on mode"', 'USINT']]
    ['276' DPT_LoadTypeSet ['609', 'DPT_1_BYTE', '"load type"', 'USINT']]
    ['277' DPT_LoadTypeDetected ['610', 'DPT_1_BYTE', '"load type detection"', 'USINT']]
    ['278' DPT_Converter_Test_Control ['611', 'DPT_1_BYTE', '"converter test control"', 'USINT']]
    ['279' DPT_Converter_Control ['612', 'DPT_1_BYTE', '"converter control"', 'USINT']]
    ['280' DPT_SABExcept_Behaviour ['801', 'DPT_1_BYTE', '"SAB except behavior"', 'USINT']]
    ['281' DPT_SABBehaviour_Lock_Unlock ['802', 'DPT_1_BYTE', '"SAB behavior on lock/unlock"', 'USINT']]
    ['282' DPT_SSSBMode ['803', 'DPT_1_BYTE', '"SSSB mode"', 'USINT']]
    ['283' DPT_BlindsControlMode ['804', 'DPT_1_BYTE', '"blinds control mode"', 'USINT']]
    ['284' DPT_CommMode ['1000', 'DPT_1_BYTE', '"communication mode"', 'USINT']]
    ['285' DPT_AddInfoTypes ['1001', 'DPT_1_BYTE', '"additional information type"', 'USINT']]
    ['286' DPT_RF_ModeSelect ['1002', 'DPT_1_BYTE', '"RF mode selection"', 'USINT']]
    ['287' DPT_RF_FilterSelect ['1003', 'DPT_1_BYTE', '"RF filter mode selection"', 'USINT']]
    ['288' DPT_StatusGen ['1', 'DPT_8_BIT_SET', '"general status"', 'Struct']]
    ['289' DPT_Device_Control ['2', 'DPT_8_BIT_SET', '"device control"', 'Struct']]
    ['290' DPT_ForceSign ['100', 'DPT_8_BIT_SET', '"forcing signal"', 'Struct']]
    ['291' DPT_ForceSignCool ['101', 'DPT_8_BIT_SET', '"forcing signal cool"', 'BOOL']]
    ['292' DPT_StatusRHC ['102', 'DPT_8_BIT_SET', '"room heating controller status"', 'Struct']]
    ['293' DPT_StatusSDHWC ['103', 'DPT_8_BIT_SET', '"solar DHW controller status"', 'Struct']]
    ['294' DPT_FuelTypeSet ['104', 'DPT_8_BIT_SET', '"fuel type set"', 'Struct']]
    ['295' DPT_StatusRCC ['105', 'DPT_8_BIT_SET', '"room cooling controller status"', 'BOOL']]
    ['296' DPT_StatusAHU ['106', 'DPT_8_BIT_SET', '"ventilation controller status"', 'Struct']]
    ['297' DPT_CombinedStatus_RTSM ['107', 'DPT_8_BIT_SET', '"combined status RTSM"', 'Struct']]
    ['298' DPT_LightActuatorErrorInfo ['601', 'DPT_8_BIT_SET', '"lighting actuator error information"', 'Struct']]
    ['299' DPT_RF_ModeInfo ['1000', 'DPT_8_BIT_SET', '"RF communication mode info"', 'Struct']]
    ['300' DPT_RF_FilterInfo ['1001', 'DPT_8_BIT_SET', '"cEMI server supported RF filtering modes"', 'Struct']]
    ['301' DPT_Channel_Activation_8 ['1010', 'DPT_8_BIT_SET', '"channel activation for 8 channels"', 'Struct']]
    ['302' DPT_StatusDHWC ['100', 'DPT_16_BIT_SET', '"DHW controller status"', 'Struct']]
    ['303' DPT_StatusRHCC ['101', 'DPT_16_BIT_SET', '"RHCC status"', 'Struct']]
    ['304' DPT_CombinedStatus_HVA ['102', 'DPT_16_BIT_SET', '"combined status HVA"', 'Struct']]
    ['305' DPT_CombinedStatus_RTC ['103', 'DPT_16_BIT_SET', '"combined status RTC"', 'Struct']]
    ['306' DPT_Media ['1000', 'DPT_16_BIT_SET', '"media"', 'Struct']]
    ['307' DPT_Channel_Activation_16 ['1010', 'DPT_16_BIT_SET', '"channel activation for 16 channels"', 'Struct']]
    ['308' DPT_OnOffAction ['1', 'DPT_2_BIT_SET', '"on/off action"', 'USINT']]
    ['309' DPT_Alarm_Reaction ['2', 'DPT_2_BIT_SET', '"alarm reaction"', 'USINT']]
    ['310' DPT_UpDown_Action ['3', 'DPT_2_BIT_SET', '"up/down action"', 'USINT']]
    ['311' DPT_HVAC_PB_Action ['102', 'DPT_2_BIT_SET', '"HVAC push button action"', 'USINT']]
    ['312' DPT_DoubleNibble ['1000', 'DPT_2_NIBBLE_SET', '"busy/nak repetitions"', 'Struct']]
    ['313' DPT_SceneInfo ['1', 'DPT_8_BIT_SET_2', '"scene information"', 'Struct']]
    ['314' DPT_CombinedInfoOnOff ['1', 'DPT_32_BIT_SET', '"bit-combined info on/off"', 'Struct']]
    ['315' DPT_ActiveEnergy_V64 ['10', 'DPT_ELECTRICAL_ENERGY', '"active energy (Wh)"', 'LINT']]
    ['316' DPT_ApparentEnergy_V64 ['11', 'DPT_ELECTRICAL_ENERGY', '"apparent energy (VAh)"', 'LINT']]
    ['317' DPT_ReactiveEnergy_V64 ['12', 'DPT_ELECTRICAL_ENERGY', '"reactive energy (VARh)"', 'LINT']]
    ['318' DPT_Channel_Activation_24 ['1010', 'DPT_24_TIMES_CHANNEL_ACTIVATION', '"activation state 0..23"', 'Struct']]
    ['319' DPT_HVACModeNext ['100', 'DPT_16_BIT_UNSIGNED_VALUE_AND_8_BIT_ENUM', '"time delay & HVAC mode"', 'Struct']]
    ['320' DPT_DHWModeNext ['102', 'DPT_16_BIT_UNSIGNED_VALUE_AND_8_BIT_ENUM', '"time delay & DHW mode"', 'Struct']]
    ['321' DPT_OccModeNext ['104', 'DPT_16_BIT_UNSIGNED_VALUE_AND_8_BIT_ENUM', '"time delay & occupancy mode"', 'Struct']]
    ['322' DPT_BuildingModeNext ['105', 'DPT_16_BIT_UNSIGNED_VALUE_AND_8_BIT_ENUM', '"time delay & building mode"', 'Struct']]
    ['323' DPT_StatusLightingActuator ['600', 'DPT_8_BIT_UNSIGNED_VALUE_AND_8_BIT_ENUM', '"Status Lighting Actuator"', 'Struct']]
    ['324' DPT_Version ['1', 'DPT_DATAPOINT_TYPE_VERSION', '"DPT version"', 'Struct']]
    ['325' DPT_AlarmInfo ['1', 'DPT_ALARM_INFO', '"alarm info"', 'Struct']]
    ['326' DPT_TempRoomSetpSetF16_3 ['100', 'DPT_3X_2_BYTE_FLOAT_VALUE', '"room temperature setpoint"', 'Struct']]
    ['327' DPT_TempRoomSetpSetShiftF16_3 ['101', 'DPT_3X_2_BYTE_FLOAT_VALUE', '"room temperature setpoint shift"', 'Struct']]
    ['328' DPT_Scaling_Speed ['1', 'DPT_SCALING_SPEED', '"scaling speed"', 'Struct']]
    ['329' DPT_Scaling_Step_Time ['2', 'DPT_SCALING_SPEED', '"scaling step time"', 'Struct']]
    ['330' DPT_MeteringValue ['1', 'DPT_4_1_1_BYTE_COMBINED_INFORMATION', '"metering value (value,encoding,cmd)"', 'Struct']]
    ['331' DPT_MBus_Address ['1000', 'DPT_MBUS_ADDRESS', '"MBus address"', 'Struct']]
    ['332' DPT_Colour_RGB ['600', 'DPT_3_BYTE_COLOUR_RGB', '"RGB value 3x(0..255)"', 'Struct']]
    ['333' DPT_LanguageCodeAlpha2_ASCII ['1', 'DPT_LANGUAGE_CODE_ISO_639_1', '"language code (ASCII)"', 'STRING']]
    ['334' DPT_Tariff_ActiveEnergy ['1', 'DPT_SIGNED_VALUE_WITH_CLASSIFICATION_AND_VALIDITY', '"electrical energy with tariff"', 'Struct']]
    ['335' DPT_Prioritised_Mode_Control ['1', 'DPT_PRIORITISED_MODE_CONTROL', '"priority control"', 'Struct']]
    ['336' DPT_DALI_Control_Gear_Diagnostic ['600', 'DPT_CONFIGURATION_DIAGNOSTICS_16_BIT', '"diagnostic value"', 'Struct']]
    ['337' DPT_DALI_Diagnostics ['600', 'DPT_CONFIGURATION_DIAGNOSTICS_8_BIT', '"diagnostic value"', 'Struct']]
    ['338' DPT_CombinedPosition ['800', 'DPT_POSITIONS', '"combined position"', 'Struct']]
    ['339' DPT_StatusSAB ['800', 'DPT_STATUS_32_BIT', '"status sunblind & shutter actuator"', 'Struct']]
    ['340' DPT_Colour_xyY ['600', 'DPT_STATUS_48_BIT', '"colour xyY"', 'Struct']]
    ['341' DPT_Converter_Status ['600', 'DPT_CONVERTER_STATUS', '"DALI converter status"', 'Struct']]
    ['342' DPT_Converter_Test_Result ['600', 'DPT_CONVERTER_TEST_RESULT', '"DALI converter test result"', 'Struct']]
    ['343' DPT_Battery_Info ['600', 'DPT_BATTERY_INFORMATION', '"Battery Information"', 'Struct']]
    ['344' DPT_Brightness_Colour_Temperature_Transition ['600', 'DPT_BRIGHTNESS_COLOUR_TEMPERATURE_TRANSITION', '"brightness colour temperature transition"', 'Struct']]
    ['345' DPT_Brightness_Colour_Temperature_Control ['600', 'DPT_STATUS_24_BIT', '"brightness colour temperature control"', 'Struct']]
    ['346' DPT_Colour_RGBW ['600', 'DPT_COLOUR_RGBW', '"RGBW value 4x(0..100%)"', 'Struct']]
    ['347' DPT_Relative_Control_RGBW ['600', 'DPT_RELATIVE_CONTROL_RGBW', '"RGBW relative control"', 'Struct']]
    ['348' DPT_Relative_Control_RGB ['600', 'DPT_RELATIVE_CONTROL_RGB', '"RGB relative control"', 'Struct']]
    ['349' DPT_GeographicalLocation ['1', 'DPT_F32F32', '"geographical location (longitude and latitude) expressed in degrees"', 'Struct']]
    ['350' DPT_TempRoomSetpSetF16_4 ['100', 'DPT_F16F16F16F16', '"Temperature setpoint setting for 4 HVAC Modes"', 'Struct']]
    ['351' DPT_TempRoomSetpSetShiftF16_4 ['101', 'DPT_F16F16F16F16', '"Temperature setpoint shift setting for 4 HVAC Modes"', 'Struct']]
