...
public enum KnxDatapointType {
  ...
  BOOL((long) 1L, (int) 0, PlcValueType.BOOL, (String) "BOOL", KnxDatapointMainType.DPT_1_BIT),
  BYTE((long) 2L, (int) 0, PlcValueType.BYTE, (String) "BYTE", KnxDatapointMainType.DPT_8_BIT_SET),
  WORD((long) 3L, (int) 0, PlcValueType.WORD, (String) "WORD", KnxDatapointMainType.DPT_16_BIT_SET),
  DWORD(
      (long) 4L,
      (int) 0,
      PlcValueType.DWORD,
  ...
  CHAR((long) 16L, (int) 0, PlcValueType.CHAR, (String) "CHAR", KnxDatapointMainType.DPT_CHARACTER),
  WCHAR(
      (long) 17L,
      (int) 0,
      PlcValueType.WCHAR,
  ...
  DT(
      ...
      KnxDatapointMainType.DPT_12_BYTE_SIGNED_VALUE),
  DPT_Switch(
      (long) 27L, (int) 1, PlcValueType.BOOL, (String) "switch", KnxDatapointMainType.DPT_1_BIT),
  DPT_Bool(
      (long) 28L, (int) 2, PlcValueType.BOOL, (String) "boolean", KnxDatapointMainType.DPT_1_BIT),
  DPT_Enable(
      (long) 29L, (int) 3, PlcValueType.BOOL, (String) "enable", KnxDatapointMainType.DPT_1_BIT),
  DPT_Ramp((long) 30L, (int) 4, PlcValueType.BOOL, (String) "ramp", KnxDatapointMainType.DPT_1_BIT),
  DPT_Alarm(
      (long) 31L, (int) 5, PlcValueType.BOOL, (String) "alarm", KnxDatapointMainType.DPT_1_BIT),
  DPT_BinaryValue(
      (long) 32L,
      (int) 6,
      PlcValueType.BOOL,
  ...
  DPT_Step((long) 33L, (int) 7, PlcValueType.BOOL, (String) "step", KnxDatapointMainType.DPT_1_BIT),
  DPT_UpDown(
      (long) 34L, (int) 8, PlcValueType.BOOL, (String) "up/down", KnxDatapointMainType.DPT_1_BIT),
  DPT_OpenClose(
      (long) 35L,
      (int) 9,
      PlcValueType.BOOL,
  ...
  DPT_Start(
      ...
      KnxDatapointMainType.DPT_1_BIT),
  DPT_State(
      (long) 37L, (int) 11, PlcValueType.BOOL, (String) "state", KnxDatapointMainType.DPT_1_BIT),
  DPT_Invert(
      (long) 38L, (int) 12, PlcValueType.BOOL, (String) "invert", KnxDatapointMainType.DPT_1_BIT),
  DPT_DimSendStyle(
      (long) 39L,
      (int) 13,
      PlcValueType.BOOL,
  ...
  DPT_InputSource(
      ...
      KnxDatapointMainType.DPT_1_BIT),
  DPT_Reset(
      (long) 41L, (int) 15, PlcValueType.BOOL, (String) "reset", KnxDatapointMainType.DPT_1_BIT),
  DPT_Ack(
      (long) 42L,
      (int) 16,
      PlcValueType.BOOL,
      ...
      KnxDatapointMainType.DPT_1_BIT),
  DPT_Trigger(
      (long) 43L, (int) 17, PlcValueType.BOOL, (String) "trigger", KnxDatapointMainType.DPT_1_BIT),
  DPT_Occupancy(
      (long) 44L,
      (int) 18,
      PlcValueType.BOOL,
  ...
  DPT_LogicalFunction(
      ...
      KnxDatapointMainType.DPT_1_BIT),
  DPT_Scene_AB(
      (long) 47L, (int) 22, PlcValueType.BOOL, (String) "scene", KnxDatapointMainType.DPT_1_BIT),
  ...
  DPT_Date(
      (long) 123L, (int) 1, PlcValueType.Struct, (String) "date", KnxDatapointMainType.DPT_DATE),
  DPT_Value_4_Ucount(
      (long) 124L,
      (int) 1,
      PlcValueType.UDINT,
